            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('playlists.update', $playlist) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" value="{{ $playlist->name }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    </div>

                    <!-- Duration -->
                    <div class="mb-4">
                        <label for="duration" class="block text-sm font-medium text-gray-700">Duration (minutes)</label>
                        <input type="number" name="duration" id="duration" value="{{ $playlist->total_duration }}" required disabled class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm ">
                    </div>

                    <!-- Songs -->
                    <div class="mb-4">
                        <label for="songs" class="block text-sm font-medium text-gray-700">Playlists</label>
